...
const SKILLS: Skill[] = [
    {
        ...
        testType: 'FLASHCARDS',
        title: 'Flashcards',
        description: 'Learn new words with spaced-repetition cards. Review at the optimal moment before you forget.',
        icon: Layers,
        href: '/tests/vocab/flashcards',
        duration: '10–15 min',
        questions: 'Adaptive deck',
        color: '#6366f1',
    ...
    },
    {
        ...
        testType: 'FILL_IN',
        title: 'Fill-in',
        description: 'Complete sentences by choosing the correct word from context. Great for learning usage.',
        icon: Type,
        href: '/tests/vocab/fill-in',
        duration: '10–15 min',
    ...
    },
    {
        ...
        testType: 'WORD_FORMS',
        title: 'Word Forms',
        description: 'Practice noun, verb, adjective, and adverb forms of the same root word.',
        icon: RefreshCw,
        href: '/tests/vocab/word-forms',
        duration: '10 min',
        questions: '20 questions',
        color: '#10b981',
...
export default function VocabularyPage() {
    ...
    const flashcardsQuota = quota?.quotas['FLASHCARDS']
    ...
    return (
        <div className="w-full min-h-full bg-[#f8f9fd] px-5 md:px-8 py-6 flex flex-col gap-6">
            ...
            <PageBanner
                visible={visible}
                tag="Vocabulary Training"
                title={<>Build a <span style={{ color: '#c7d2fe' }}>powerful word bank.</span></>}
                subtitle="Spaced-repetition flashcards, contextual exercises, and level-based word lists from A1 to C2."
                ctaLabel="Start training"
                onCta={() => router.push('/tests/vocabulary/flashcards')}
                stats={[
                    { icon: Clock, value: '10–20 min', label: 'Per session' },
                    { icon: BarChart2, value: 'A1 – C2', label: 'Level range' },
                    { icon: CheckCircle, value: '3 modes', label: 'Cards · Fill-in · Forms' },
                ]}
            />
            ...
            >
                ...
                >
                    <BookMarked size={12} style={{ color: C1 }} />
                    ...
                    {quotaLoading ? (
                        ...
                        <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-gray-100 shadow-sm">
                            <span className="text-sm font-bold" style={{ color: C1 }}>
                                {flashcardsQuota.limit === -1 ? '∞' : flashcardsQuota.remaining}
                            </span>
            ...
            >
                Flashcards are free &nbsp;•&nbsp; More modes coming soon &nbsp;•&nbsp; Results shown instantly
            </p>
        </div>
    )
}