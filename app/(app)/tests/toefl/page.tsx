...
const SKILLS: Skill[] = [
    {
        ...
        testType: 'READING',
        title: 'Reading',
        description: '3–4 academic passages with 10 questions each. Tests your ability to understand university-level text.',
        icon: BookOpen,
        href: '/tests/toefl/reading',
        duration: '54–72 min',
    ...
    },
    {
        ...
        testType: 'LISTENING',
        title: 'Listening',
        description: 'Lectures and conversations from a university setting. Tests comprehension and note-taking skills.',
        icon: Headphones,
        href: '/tests/toefl/listening',
        duration: '41–57 min',
    ...
    },
    {
        ...
        testType: 'SPEAKING',
        title: 'Speaking',
        description: '4 tasks including independent and integrated speaking. Recorded and scored on fluency and coherence.',
        icon: Mic,
        href: '/tests/toefl/speaking',
        duration: '17 min',
        questions: '4 tasks',
        color: '#f59e0b',
    ...
    },
    {
        ...
        testType: 'WRITING',
        title: 'Writing',
        description: 'Integrated writing from reading+listening, plus an academic discussion task.',
        icon: PenLine,
        href: '/tests/toefl/writing',
        duration: '50 min',
        questions: '2 tasks',
        color: '#10b981',
...
export default function TOEFLPage() {
    ...
    const readingQuota = quota?.quotas['READING']
    ...
    return (
        <div className="w-full min-h-full bg-[#f8f9fd] px-5 md:px-8 py-6 flex flex-col gap-6">
            ...
            <PageBanner
                visible={visible}
                tag="TOEFL Practice"
                title={<>Ace your <span style={{ color: '#c7d2fe' }}>university admission.</span></>}
                subtitle="Academic reading, listening, speaking and writing — all four sections, real exam format."
                ctaLabel="Start full test"
                onCta={() => router.push('/tests/toefl/full')}
                stats={[
                    { icon: Clock, value: '~3 hrs', label: 'Full test duration' },
                    { icon: BarChart2, value: '0–120 pts', label: 'Score range' },
                    { icon: CheckCircle, value: '4 sections', label: 'R · L · S · W' },
                ]}
            />
            ...
            >
                ...
                >
                    <GraduationCap size={12} style={{ color: C1 }} />
                    <span className="text-[11px] font-semibold" style={{ color: C2 }}>Choose a section</span>
                </div>
                    ...
                    {quotaLoading ? (
                        ...
                        <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-gray-100 shadow-sm">
                            <span className="text-sm font-bold" style={{ color: C1 }}>
                                {readingQuota.limit === -1 ? '∞' : readingQuota.remaining}
                            </span>
                            <span className="text-xs text-gray-400">Reading left</span>
                        </div>
                    ) : (
            ...
            >
                Reading is free &nbsp;•&nbsp; More sections coming soon &nbsp;•&nbsp; Results shown instantly
            </p>
        </div>
    )
}