...
const SKILLS: Skill[] = [
    {
        ...
        testType: 'READING',
        title: 'Reading',
        description: '3 passages, 40 questions. Academic or General Training texts under timed conditions.',
        icon: BookOpen,
    ...
    },
    {
        ...
        testType: 'LISTENING',
        title: 'Listening',
        description: '4 recordings of native English speakers with a variety of accents and question types.',
        icon: Headphones,
    ...
    },
    {
        ...
        testType: 'WRITING',
        title: 'Writing',
        description: 'Task 1: describe a visual. Task 2: write an argumentative essay within the time limit.',
        icon: PenLine,
    ...
    },
    {
        ...
        testType: 'SPEAKING',
        title: 'Speaking',
        description: 'Practise the three-part speaking test: introduction, long turn, and two-way discussion.',
        icon: Mic,
    ...
    return (
        <div className="w-full min-h-full bg-[#f8f9fd] px-5 md:px-8 py-6 flex flex-col gap-6">
            ...
            <PageBanner
                visible={visible}
                tag="IELTS Practice"
                title={<>Master the <span style={{ color: '#c7d2fe' }}>IELTS exam.</span></>}
                subtitle="Full-length practice tests in Reading, Listening, Writing, and Speaking — formatted exactly like the real exam."
                ctaLabel="Start full test"
                onCta={() => router.push('/tests/ielts/full')}
                stats={[
                    { icon: Clock, value: '2h 45m', label: 'Full test duration' },
                    { icon: BarChart2, value: 'Band 1–9', label: 'Score range' },
                    { icon: CheckCircle, value: '4 sections', label: 'Reading · Listening · Writing · Speaking' },
                ]}
            />
            ...
            >
                ...
                >
                    <BookOpen size={12} style={{ color: C1 }} />
            ...
            >
                Reading is free &nbsp;•&nbsp; More skills coming soon &nbsp;•&nbsp; Results shown instantly
            </p>
        </div>
    )
}